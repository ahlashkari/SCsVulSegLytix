"""
The BERT architecture, rearranged to conform to the pre-LN structure
and with support for the TransAtt interpretability framework.
This model is used during inference since it provides additional methods
relating to explainability, but it's not used during training because
it incurs computational overhead compared to vanilla BERT.
...
class BertPooler(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        pooled_output = first_token_tensor#self.dense(first_token_tensor)
...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        req = hidden_states.requires_grad
...
class BertSelfOutput(nn.Module):
    ...
    def forward(self, hidden_states, input_tensor):
        ...
        hidden_states = add#self.LayerNorm(add)
